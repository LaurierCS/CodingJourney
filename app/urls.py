...
urlpatterns = [
    ...
    # ************************************************************
    path('login', viewsFile.login_handler, name="login"),
    path('register', viewsFile.registration_handler, name="register"),
    path('logout', viewsFile.logout_handler, name="logout"),
    path('update-ds-description', viewsFile.update_desired_skill, name="update_ds"),
    path('experience-handler', viewsFile.experience_input_handler, name="experience-handler"),
    path('search', viewsFile.SearchQueries.searchHandle, name="search_page"),
    ...
    path('experience-input', viewsFile.experience_input_handler, name="exp-input-test"),
