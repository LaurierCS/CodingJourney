# Generated by Django 3.1.13 on 2022-05-05 21:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node_type', models.CharField(choices=[('C', 'Category'), ('N', 'Node')], default='C', max_length=40)),
                ('parent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.skill')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app.skill')),
            ],
        ),
        migrations.CreateModel(
            name='DesiredSkill',
